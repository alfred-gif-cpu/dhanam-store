...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static void switchTab(int index) =>
      _instance?.setState(() => _instance!._navIndex = index);
...
class _HomeTabState extends State<_HomeTab>
  ...
  Future<void> _loadRecentlyViewed() async {
    ...
    try {
      final products = await _api.getProductsByIds(
        _recentService.ids.take(10).toList(),
      );
                  ...
                  children: [
                    ...
                    if (_categories.isNotEmpty) ...[
                      ...
                      CategoryCarousel(
                        ...
                        onTap: (cat) {
                          BrowseScreen.filterByCategory(cat);
                    ...
                    if (_flashDeals.isNotEmpty)
                      FlashDealSection(products: _flashDeals),
                    ...
                    if (_bestsellers.isNotEmpty) ...[
                      ...
                      Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: _bestsellers.length > 6
                              ? 6
                              : _bestsellers.length,
                          gridDelegate:
                          ...
                          itemBuilder: (_, i) =>
                              ProductCard(product: _bestsellers[i]),
                        ),
                      ),
                    ],
