...
class _BrowseScreenState extends State<BrowseScreen> {
  ...
  Future<void> _loadProducts() async {
    ...
    try {
      final response = await _api.getProducts(category: _selectedCategory, limit: 100);
      setState(() { _products = response.products; _total = response.total; _loading = false; });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Browse Products'), centerTitle: true, elevation: 0),
      body: Column(
        children: [
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text('Search products, brands...', style: TextStyle(fontSize: 15, color: Colors.grey[400])),
                  ],
                ),
              ),
            ),
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return FilterChip(
                    ...
                    labelStyle: TextStyle(color: selected ? Colors.green[800] : Colors.grey[700], fontWeight: selected ? FontWeight.w600 : FontWeight.normal),
          ...
          Padding(
            ...
            child: Align(
              ...
              child: Text(_loading ? 'Loading...' : '$_total products found',
